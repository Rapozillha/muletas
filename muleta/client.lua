...
local localization = {
	['ragdoll'] = "Não podes usar uma muleta enquanto estás em ragdoll!",
	['falling'] = "Não podes usar uma muleta quando estás a cair!",
	['combat'] = "Não podes usar uma muleta em combate!",
	['dead'] = "Não podes usar uma muleta enquanto estás morto!",
	['vehicle'] = "Não podes usar uma muleta enquanto estás num veículo!",
	['weapon'] = "Não podes usar uma muleta enquanto tens uma arma na mão!",
	['pickup'] = "Prime ~INPUT_PICKUP~ para pegar na muleta!",
	['forced'] = "Tens de usar a muleta por mais algum tempo!"
}
